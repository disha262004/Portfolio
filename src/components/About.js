        ...
        <div className="container-fluid px-5 mb-5">
            <div className="row px-5" style={{color:"#00000"}}>
                ...
                <div className="row-col text-center my-4">
                    <a href="#" className="p-3" ><img src="./media/images/in.png" alt="img"  style={{width:"3%"}}/></a>
                    <a href="#" className="p-3" ><img src="./media/images/gihub.png" alt="img" style={{width:"3%"}} /></a>
                    <a href="#" className="p-3" ><img src="./media/images/gmail.png" alt="img" style={{width:"3%"}} /></a>
                    <a href="#" className="p-3" ><img src="./media/images/gfg.png" alt="img" style={{width:"3%"}} /></a>
                    <a href="#" className="p-3" ><img src="./media/images/leetcode.png" alt="img" style={{width:"3%"}} /></a>
                </div>
            </div>
        </div>
     );
